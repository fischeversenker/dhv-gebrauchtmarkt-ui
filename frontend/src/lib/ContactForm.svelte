...
<template>
  <form on:submit={onSubmit} action="">
    ...
    <div class="field">
      ...
      <div class="control">
        <textarea class="textarea" placeholder="Deine Nachricht" required bind:value={message}></textarea>
      </div>
    </div>
    ...
    <div class="field">
      <div class="control">
        <label class="checkbox">
          ...
          <a href="https://www.dhv.de/fileadmin/user_upload/aktuell_zu_halten/gebrauchtmarkt/gm_nutzungsbedingungen.pdf" target="_blank" rel="noopener">AGB</a> gelesen und akzeptiert
        </label>
      </div>
    </div>
